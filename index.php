...
<head>
    <title><? echo lang('welcome'); ?> | Bedebah</title>
    <meta charset="UTF-8">
    <meta name="description" content="Bedebah is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,Bedebah,meet,free platform">
    <meta name="author" content="Ahmad Robbiul Iman">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <?php include "includes/head_imports_main.php";?>
</head>
    <body class="login_signup_body" style="background-image: url('imgs/wp4068641.jpg')">
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
        <a href="index" class="login_signup_navbarLinks">
                        <img src="imgs/main_icons/6.png" height="65px"></a>
                <div style="float: <? echo lang('float2'); ?>;">
                    <a href="login.php" class="login_signup_btn1"><? echo lang('login'); ?></a>
                    <a href="signup.php" class="login_signup_btn2"><? echo lang('signup'); ?></a>
                </div>
        </div>
        <!--============[ main contains ]============-->
        <div class="login_signup_box">
        <h3 align="center"><? echo lang('welcome_to'); ?> Bedebah</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('wallstant_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/78-removebg-preview.png" alt="Wallstant" style="width: 300px; center"  />
                </div>
            </div>
        </div>
