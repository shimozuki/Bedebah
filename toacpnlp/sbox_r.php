...
<head>
    <title><? echo lang('dashboard'); ?> | Bedebah</title>
    <admin charset="UTF-8">
    <admin name="description" content="Bedebah is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
